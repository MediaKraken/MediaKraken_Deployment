...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.main_frame_bottom, 1, 1, 1, 3)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("../images/photo.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.main_button_images.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("../images/radio.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.main_button_radio.setIcon(icon6)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("../images/books.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.main_button_books.setIcon(icon7)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("../images/settings.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.main_button_settings.setIcon(icon8)
        self.main_button_settings.setObjectName("main_button_settings")
        self.verticalLayout_2.addWidget(self.main_button_settings)
        self.gridLayout.addWidget(self.main_frame_right, 0, 3, 1, 1)
        self.main_frame_left = QtWidgets.QFrame(self.centralWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(4)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("../images/progress.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.main_button_inprogress.setIcon(icon9)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("../images/new.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.main_button_new.setIcon(icon10)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap("../images/vid_game.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.main_button_games.setIcon(icon11)
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap("../images/music_vid.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.main_button_music_video.setIcon(icon12)
        ...
        self.gridLayout.addWidget(self.main_frame_left, 0, 1, 1, 1)
        ...
        self.formLayout = QtWidgets.QFormLayout(self.main_frame_media)
