...
class BackupEditForm(Form):
    ...
    #interval = SelectField('Interval', choices=[('Hours', 'Hours'), ('Days', 'Days'), ('Weekly', 'Weekly')])
...
class AdminSettingsForm(Form):
    ...
    #country = SelectField('Interval', choices=[('Hours', 'Hours'), ('Days', 'Days'), ('Weekly', 'Weekly')])
    ...
    #meta_language = SelectField('Interval', choices=[('Hours', 'Hours'), ('Days', 'Days'), ('Weekly', 'Weekly')])
