...
# mpeg2video           MPEG-2 video (decoders: mpeg2video mpegvideo )
    target_audio_channels = SelectField("Audio Channels", choices=[('1.0', '1.0 Mono'),\
        ...
        ('6.1', '6.1 Surround'), ('7.1', '7.1 Surround'), ('Copy', 'Copy')])
    target_audio_codec = SelectField("Audio Codec", choices=[('Copy', 'Copy'),\
        ('aac', 'AAC (Advanced Audio Coding)'), ('ac3', 'ATSC A/52A (AC-3)'),\
        ('dts', 'DCA (DTS Coherent Acoustics)'), ('flac', 'FLAC'), ('mp3', 'MP3'),\
        ('opus', 'Opus'), ('truehd', 'TrueHD'), ('vorbis', 'Vorbis')])
    target_sample_rate = SelectField("Sample Rate", choices=[('Default', 'Default'),\
        ('22050', '22,050'), ('44100', '44,100 Audio CD'), ('96000', '96,000 DVD-Audio'),\
        ('192000', 'DVD-Audio'), ('2822400', '2,822,400 SACD')])
