...
<BR>
 ...
 <ul style="color:white;">
        <li><b>0.7.8 - Base Excel code, Base Xbox Live code, lazy load images, base Soundcloud code, base Instragram code, base BeautifulHue code - Current DEV branch on GitHub</b>
