...
<BR>
 ...
 <ul style="color:white;">
        <li><b>0.7.7 - Redis 3.2.11, Nginx 1.13.6, PostgreSQL 9.6.6, different theaters (controller, thin, etc), bad bot blocker, base lms code, base weather code, base translation code - Current DEV branch on GitHub</b>
