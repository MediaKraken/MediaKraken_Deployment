...
<BR>
 ...
 <ul style="color:white;">
        <li><b>0.7.7 - different theaters (controller, thin, etc), bad bot blocker, base lms code, base weather code, base translation code - Current DEV branch on GitHub</b>
