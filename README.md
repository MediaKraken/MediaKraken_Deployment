...
<BR>
 ...
 <ul style="color:white;">
        <li><b>0.7.9 - Clean up disc read, basic videojs resume, base SoundCloud videojs, base Frame by Frame videojs, background videojs - Current DEV branch on GitHub</b>
