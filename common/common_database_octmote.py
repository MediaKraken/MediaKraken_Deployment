    ...
    def com_db_open(self, db_file=None):
        ...
        if create_db:
            ...
            self.db_cursor.execute('insert into octmote_device (device_guid, device_name,'\
                ...
                (str(uuid.uuid4()),))
            self.db_cursor.execute('insert into octmote_device (device_guid, device_name,'\
                ' device_description) values (?,\'VHS\', \'VHS VCR\')', (str(uuid.uuid4()),))
            self.db_cursor.execute('insert into octmote_device (device_guid, device_name,'\
                ' device_description) values (?,\'Beta\', \'Beta VCR\')', (str(uuid.uuid4()),))
            self.db_cursor.execute('insert into octmote_device (device_guid, device_name,'\
                ' device_description) values (?,\'TV\', \'Television\')', (str(uuid.uuid4()),))
            self.db_cursor.execute('insert into octmote_device (device_guid, device_name,'\
            ...
            self.db_cursor.execute('insert into octmote_device (device_guid, device_name,'\
                ...
                (str(uuid.uuid4()),))
            self.db_cursor.execute('insert into octmote_device (device_guid, device_name,'\
                ' device_description) values (?,\'Tape\', \'Tape Deck\')', (str(uuid.uuid4()),))
            self.db_cursor.execute('insert into octmote_device (device_guid, device_name,'\
            ...
            self.db_cursor.execute('insert into octmote_device (device_guid, device_name,'\
                ...
                (str(uuid.uuid4()),))
            self.db_cursor.execute('insert into octmote_device (device_guid, device_name,'\
                ' device_description) values (?,\'Net/USB\', \'Net/USB\')', (str(uuid.uuid4()),))
            self.db_cursor.execute('insert into octmote_device (device_guid, device_name,'\
            ...
            self.db_cursor.execute('insert into octmote_device (device_guid, device_name,'\
                ...
                (str(uuid.uuid4()),))
            self.db_cursor.execute('insert into octmote_device (device_guid, device_name,'\
                ' device_description) values (?,\'Game\', \'Game System\')', (str(uuid.uuid4()),))
            self.db_cursor.execute('insert into octmote_device (device_guid, device_name,'\
