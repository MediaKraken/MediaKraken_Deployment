...
class CommonDatabaseOctmote(object):
    ...
    def com_db_open(self, db_file=None):
        ...
        if create_db:
            ...
            self.db_cursor.execute("insert into octmote_device (device_guid, device_name, device_description) values (?,'Laserdisc', 'Laser Disc Player')", (str(uuid.uuid4()),))
            self.db_cursor.execute("insert into octmote_device (device_guid, device_name, device_description) values (?,'VHS', 'VHS VCR')", (str(uuid.uuid4()),))
            self.db_cursor.execute("insert into octmote_device (device_guid, device_name, device_description) values (?,'Beta', 'Beta VCR')", (str(uuid.uuid4()),))
            self.db_cursor.execute("insert into octmote_device (device_guid, device_name, device_description) values (?,'TV', 'Television')", (str(uuid.uuid4()),))
            self.db_cursor.execute("insert into octmote_device (device_guid, device_name, device_description) values (?,'Projector', 'DLP, LCD, LED Projector')", (str(uuid.uuid4()),))
            self.db_cursor.execute("insert into octmote_device (device_guid, device_name, device_description) values (?,'CRT Projector', 'CRT Analog Projector')", (str(uuid.uuid4()),))
            self.db_cursor.execute("insert into octmote_device (device_guid, device_name, device_description) values (?,'3D BluRay', '3D Capable BluRay Player')", (str(uuid.uuid4()),))
            self.db_cursor.execute("insert into octmote_device (device_guid, device_name, device_description) values (?,'3D Projector', 'DLP, LCD, LED 3D Projector')", (str(uuid.uuid4()),))
            self.db_cursor.execute("insert into octmote_device (device_guid, device_name, device_description) values (?,'Phono', 'Analog Phonograph Player')", (str(uuid.uuid4()),))
            self.db_cursor.execute("insert into octmote_device (device_guid, device_name, device_description) values (?,'DAC', 'Digital To Analog Converter')", (str(uuid.uuid4()),))
            self.db_cursor.execute("insert into octmote_device (device_guid, device_name, device_description) values (?,'Tape', 'Tape Deck')", (str(uuid.uuid4()),))
            self.db_cursor.execute("insert into octmote_device (device_guid, device_name, device_description) values (?,'CD', 'Compact Disc Player')", (str(uuid.uuid4()),))
            self.db_cursor.execute("insert into octmote_device (device_guid, device_name, device_description) values (?,'SACD', 'Super Audio Compact Disc Player')", (str(uuid.uuid4()),))
            self.db_cursor.execute("insert into octmote_device (device_guid, device_name, device_description) values (?,'SVHS', 'Super VHS VCR')", (str(uuid.uuid4()),))
            self.db_cursor.execute("insert into octmote_device (device_guid, device_name, device_description) values (?,'SBeta', 'Super Beta VCR')", (str(uuid.uuid4()),))
            self.db_cursor.execute("insert into octmote_device (device_guid, device_name, device_description) values (?,'Receiver', 'Audio/Video Receiver')", (str(uuid.uuid4()),))
            self.db_cursor.execute("insert into octmote_device (device_guid, device_name, device_description) values (?,'Amplifier', 'Audio Amplifier')", (str(uuid.uuid4()),))
            self.db_cursor.execute("insert into octmote_device (device_guid, device_name, device_description) values (?,'Decoder', '\"Description\":\"Audio Decoder\"')", (str(uuid.uuid4()),))
            self.db_cursor.execute("insert into octmote_device (device_guid, device_name, device_description) values (?,'DAT', 'Digital Audio Tape')", (str(uuid.uuid4()),))
            self.db_cursor.execute("insert into octmote_device (device_guid, device_name, device_description) values (?,'Reel', 'Reel To Reel Tape')", (str(uuid.uuid4()),))
            self.db_cursor.execute("insert into octmote_device (device_guid, device_name, device_description) values (?,'Cable', 'Cable TV')", (str(uuid.uuid4()),))
            self.db_cursor.execute("insert into octmote_device (device_guid, device_name, device_description) values (?,'Satellite ', 'Satellite  TV')", (str(uuid.uuid4()),))
            self.db_cursor.execute("insert into octmote_device (device_guid, device_name, device_description) values (?,'Net/USB', 'Net/USB')", (str(uuid.uuid4()),))
            self.db_cursor.execute("insert into octmote_device (device_guid, device_name, device_description) values (?,'Vid Proc', 'Video Processor')", (str(uuid.uuid4()),))
            self.db_cursor.execute("insert into octmote_device (device_guid, device_name, device_description) values (?,'Stream', 'Audio/Video Streaming Device')", (str(uuid.uuid4()),))
            self.db_cursor.execute("insert into octmote_device (device_guid, device_name, device_description) values (?,'Game', 'Game System')", (str(uuid.uuid4()),))
