...
def com_metadata_netflixroulette_get_id(media_title):
    """
    Get id by name
    """
...
def com_metadata_netflixroulette_get_director(media_title):
    """
...
def com_metadata_netflixroulette_get_summary(media_title):
    """
...
def com_metadata_netflixroulette_get_category(media_title):
    """
...
def com_metadata_netflixroulette_get_cast(media_title):
    """
    Get cast by title
    """
...
def com_metadata_netflixroulette_get_release_year(media_title):
    """
    Get release year
    """
...
def com_metadata_netflixroulette_get_type(media_title):
    """
    Get type by name
    """
...
def com_metadata_netflixroulette_get_media_poster(media_title):
    """
    Get media poster
    """
...
def com_metadata_netflixroulette_get_rating(media_title):
    """
    Get rating
    """
...
def com_metadata_netflixroulette_get_version():
    """
    Get version
    """
    return get_version()
