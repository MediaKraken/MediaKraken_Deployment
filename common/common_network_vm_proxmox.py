...
#'''
    ...
    def com_net_prox_lxc_index(self, node_name, vm_id):
        return self.proxmox_instance.getContainerIndex(node_name, vm_id)


    def com_net_prox_lxc_status(self, node_name, vm_id):
        return self.proxmox_instance.getContainerStatus(node_name, vm_id)


    def com_net_prox_lxc_config(self, node_name, vm_id):
        return self.proxmox_instance.getContainerConfig(node_name, vm_id)


    def com_net_prox_lxc_init_log(self, node_name, vm_id):
...
#
#'''
    def com_net_prox_kvm_index(self, node_name, vm_id):
        return self.proxmox_instance.getVirtualIndex(node_name, vm_id)


    def com_net_prox_kvm_status(self, node_name, vm_id):
        return self.proxmox_instance.getVirtualStatus(node_name, vm_id)


    def com_net_prox_kvm_config(self, node_name, vm_id):
...
#'''
    ...
    def com_net_prox_lxc_start(self, node_name, vm_id):
...
#
#'''
    def com_net_prox_lxc_create(self, node_name, vm_id):
        return self.proxmox_instance.createOpenvzContainer(node_name, vm_id)


    def com_net_prox_lxc_mnt_private(self, node_name, vm_id):
        return self.proxmox_instance.mountOpenvzPrivate(node_name, vm_id)


    def com_net_prox_lxc_umnt_private(self, node_name, vm_id):
...
#'''
    ...
    def com_net_prox_nic_delete(self, node_name, vm_id, nic_name):
        return self.proxmox_instance.deleteNodeInterface(node_name, vm_id, nic_name)


    def com_net_prox_kvm_delete(self, node_name, vm_id):
...
#
#'''
    def com_net_prox_set_dns(self, node_name, dns_domain):
        return self.proxmox_instance.setNodeDNSDomain(node_name, dns_domain)


    def com_net_prox_set_subscription(self, node_name, sub_key):
        return self.proxmox_instance.setNodeSubscriptionKey(node_name, sub_key)


    def com_net_prox_set_timezone(self, node_name, timezone):
        return self.proxmox_instance.setNodeTimeZone(node_name, timezone)


    def com_net_prox_lxc_set_config(self, node_name, vm_id, vm_options):
...
#
#'''
    def com_net_prox_kvm_set_config(self, node_name, vm_id, vm_options):
...
#print(stuff.com_net_prox_lxc_containers())
