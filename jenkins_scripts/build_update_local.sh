...
docker build -t mediakraken/mkbase310py3 --build-arg ALPMIRROR=10.0.0.122 --build-arg PIPMIRROR=th-pypi-1 .
...
docker-compose build  --build-arg ALPMIRROR=10.0.0.122 --build-arg PIPMIRROR=th-pypi-1 .
