...
def srv_db_media_class_list(self, offset=None, records=None):
    ...
    """
    if offset is None:
        self.sql3_cursor.execute('select mm_media_class_type,mm_media_class_guid,'\
...
def srv_db_media_class_by_uuid(self, class_uuid):
    ...
    """
    self.sql3_cursor.execute('select mm_media_class_type from mm_media_class'\
...
def srv_db_media_uuid_by_class(self, class_text):
    ...
    """
    self.sql3_cursor.execute('select mm_media_class_guid from mm_media_class'\
