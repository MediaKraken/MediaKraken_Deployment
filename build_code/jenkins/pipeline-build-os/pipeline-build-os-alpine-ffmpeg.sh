...
cp /home/metaman/github/Meta-Man.Build/lib/x265_1.9.tar.gz .
tar xzvf x265_1.9.tar.gz
cd ~/ffmpeg_sources/x265_1.9/build/linux
...
cd libvpx
./configure --prefix="$HOME/ffmpeg_build" --disable-examples --enable-pic
make -j8
make install
make clean
