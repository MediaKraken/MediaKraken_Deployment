...
for folder_name in ('common', 'conf'):
    command_string += 'ADD /root/MediaKraken_Deployment/' + folder_name + ' /home/mediakraken/.\n'
for file_name in ('README.md', 'LICENSE'):
    command_string += 'ADD /root/MediaKraken_Deployment/' + file_name + ' /home/mediakraken/.\n'
...
if len(pipeline_source_packages_ubuntu.PACKAGES_SLAVE_UBUNTU_1604) > 0:
    command_string = \
        ...
        'WORKDIR /mediakraken\n'\
        '\n'
    command_string += 'ADD /root/MediaKraken_Deployment/main_server_slave.py /home/mediakraken/.\n'
    command_string += '# Update Software repository\n'\
...
if len(pipeline_source_packages_ubuntu.PACKAGES_SERVER_UBUNTU_1604) > 0:
    ...
    for folder_name in ('database', 'metadata', 'network', 'web_app'):
        command_string += 'ADD /root/MediaKraken_Deployment/' + folder_name\
            + ' /home/mediakraken/.\n'
    for program_name in ('bulk_gamesdb_netfetch.py', 'main_server.py',\
            ...
            'subprogram*.py'):
        command_string += 'ADD /root/MediaKraken_Deployment/' + program_name\
            + ' /home/mediakraken/.\n'
    command_string += '# Update Software repository\n'\
        'RUN apt-get -y install'
