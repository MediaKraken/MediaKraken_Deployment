...
from common import common_metadata_thetvdb_v2

options, status = db_connection.db_opt_status_read()
print(options)
thetvdb_connection = common_metadata_thetvdb_v2.CommonMetadataTheTVDBv2(options)

print(thetvdb_connection.com_meta_thetvdbv2_login())
