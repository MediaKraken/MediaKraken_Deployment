...
class MKConsumer:
    ...
    def add_on_channel_close_callback(self):
        common_logging_elasticsearch_httpx.com_es_httpx_post(message_type='info', message_text={
            'pika': 'Adding channel close callback'})
