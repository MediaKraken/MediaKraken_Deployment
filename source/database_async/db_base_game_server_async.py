...
async def db_game_server_upsert(self, db_connection, server_name, server_json):
    """
    Upsert a game server into the database
    """
    new_guid = str(uuid.uuid4())
    await db_connection.execute('INSERT INTO mm_game_dedicated_servers (mm_game_server_guid,'
                                ' mm_game_server_name,'
                                ' mm_game_server_json)'
                                ' VALUES ($1, $2, $3)'
