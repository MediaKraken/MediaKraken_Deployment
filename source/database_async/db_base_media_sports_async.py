...
def db_media_sports_list(self, db_connection, class_guid, offset=None, list_limit=0,
                         search_text=None,
...
def db_media_sports_list_count(self, db_connection, class_guid, list_type=None, list_genre='All',
