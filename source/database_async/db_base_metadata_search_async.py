...
def db_metadata_search(self, db_connection, search_string, search_type='Local',
                       search_movie=True,
                       search_tvshow=True,
                       search_album=True,
                       search_image=True,
    ...
    if search_type == 'Local':
        if search_movie:
            # movie section
            json_return_data['Movie'] = json.dumps(db_connection.fetch('SELECT mm_metadata_guid,'
                                                                       ' mm_media_name, '
        ...
        if search_tvshow:
            ...
            json_return_data['TVShow'] = json.dumps(
                db_connection.fetch('SELECT mm_metadata_tvshow_guid,'
        ...
        if search_album:
            ...
            json_return_data['Album'] = json.dumps(
                db_connection.fetch('SELECT mm_metadata_album_guid,'
        ...
        if search_publication:
            ...
            json_return_data['Publication'] = json.dumps(
                db_connection.fetch('SELECT mm_metadata_book_guid,'
        ...
        if search_game:
            # game section
            json_return_data['Game'] = json.dumps(db_connection.fetch('SELECT gi_id,'
                                                                      ' gi_game_info_name,'
