def db_collection_list(self, db_connection, offset=None, records=None, search_value=None):
    """
    Return collections list from the database
    """
    if offset is None:
        if search_value is not None:
            return db_connection.fetch('select mm_metadata_collection_guid,'
...
def db_collection_list_count(self, db_connection, search_value=None):
    if search_value is not None:
...
def db_collection_read_by_guid(self, db_connection, media_uuid):
    """
    Collection details
    """
