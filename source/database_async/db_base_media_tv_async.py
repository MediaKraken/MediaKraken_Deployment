def db_media_tv_list(self, db_connection, genre_type=None, list_limit=None,
                     group_collection=False, offset=0, search_value=None):
    """
    # grab tv data
    """
    if search_value is not None:
        return db_connection.fetch('select mm_metadata_tvshow_name,'
...
def db_media_tv_list_count(self, db_connection, genre_type=None, group_collection=False,
                           search_value=None):
    """
    # grab tv data count
    """
    sql_data = db_connection.fetch('select count(*) from mm_metadata_tvshow, mm_media'
