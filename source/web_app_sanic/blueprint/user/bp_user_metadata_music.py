...
async def url_bp_user_metadata_music_album_list(request):
    ...
    media = []
    for album_data in g.db_connection.db_meta_album_list(db_connection, offset, per_page,
...
async def metadata_music_album_song_list(request):
    ...
    return {
        'media': g.db_connection.db_meta_song_list(db_connection, offset, per_page,
                                                   request['session']['search_text']),
        'page': page,
        'per_page': per_page,
        'pagination': pagination,
