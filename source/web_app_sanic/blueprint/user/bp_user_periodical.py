...
async def url_bp_user_periodical_list(request):
    ...
    pagination = Pagination(request,
                            total=await request.app.db_functions.db_media_book_list_count(db_connection,
    ...
    return {
        'media': await request.app.db_functions.db_media_book_list(db_connection, offset, per_page,
                                                    request['session']['search_text']),
        'page': page,
        'per_page': per_page,
