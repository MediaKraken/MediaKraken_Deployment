...
#     else:
#         pass_guid = guid
#         common_logging_elasticsearch_httpx.com_es_httpx_post_async(message_type='info', message_text= {"hls path": pass_guid})
...
#     """
#     common_logging_elasticsearch_httpx.com_es_httpx_post_async(message_type='info', message_text= {'user_playback action': action,
#                                                      'case user': user.id})
#     # pull the media stats
#     common_logging_elasticsearch_httpx.com_es_httpx_post_async(message_type='info', message_text= {'args': request.args})
#     common_logging_elasticsearch_httpx.com_es_httpx_post_async(message_type='info', message_text= {'form': request.form})
