...
@common_global.jinja_template.template('bss_user/metadata/bss_metadata_game.html')
...
@common_global.jinja_template.template('bss_user/metadata/bss_metadata_game_detail.html')
@common_global.auth.login_required
