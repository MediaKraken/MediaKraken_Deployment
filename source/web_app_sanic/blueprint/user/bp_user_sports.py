...
async def url_bp_user_sports(request):
    ...
    media = []
    for row_data in g.db_connection.db_media_sports_list(db_connection,
    ...
    pagination = Pagination(request,
                            total=g.db_connection.db_media_sports_list_count(db_connection,
...
async def url_bp_user_sports_detail(request, guid):
    ...
    try:
        ...
        data_background_image = None
    return {
        'data': g.db_connection.db_metathesportsdb_select_guid(db_connection, guid),
