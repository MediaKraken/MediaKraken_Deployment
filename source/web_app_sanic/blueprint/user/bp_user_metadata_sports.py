...
@common_global.jinja_template.template('bss_user/metadata/bss_metadata_sports_detail.html')
...
@common_global.jinja_template.template('bss_user/metadata/bss_metadata_sports_list.html')
@common_global.auth.login_required
