...
@blueprint_user_media_iradio.route('/iradio', methods=['GET', 'POST'])
...
@blueprint_user_media_iradio.route('/iradio_detail/<guid>')
@common_global.jinja_template.template('user/user_media_iradio.html')
@common_global.auth.login_required
