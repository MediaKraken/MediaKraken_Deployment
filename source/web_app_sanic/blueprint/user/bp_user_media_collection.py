...
async def url_bp_user_metadata_movie_collection(request):
    ...
    media = []
    for row_data in g.db_connection.db_collection_list(db_connection, offset, per_page,
    ...
    pagination = Pagination(request,
                            total=g.db_connection.db_collection_list_count(db_connection,
                                request['session']['search_text']),
...
async def url_bp_user_metadata_movie_collection_detail(request, guid):
    ...
    """
    data_metadata = g.db_connection.db_collection_read_by_guid(db_connection, guid)
