...
@common_global.jinja_template.template('bss_user/metadata/bss_metadata_movie_detail.html')
...
@common_global.jinja_template.template('bss_user/metadata/bss_metadata_movie_list.html')
