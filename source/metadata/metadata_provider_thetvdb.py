...
class CommonMetadataTheTVDB:
    ...
    #        mirror_list_xml = await common_network_async.mk_network_fetch_from_url_async('http://thetvdb.com/api/'
        ...
        await common_logging_elasticsearch_httpx.com_es_httpx_post_async(message_type='info',
                                                                         message_text={
                                                                             ...
                                                                             'caller':
                                                                                 inspect.stack()[1][
                                                                                     3]})
        return await common_network_async.mk_network_fetch_from_url_async('http://thetvdb.com/api/'
