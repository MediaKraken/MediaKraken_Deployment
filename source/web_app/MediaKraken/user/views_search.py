...
from quart import Blueprint, render_template, g, request, redirect, url_for, session
...
async def search_media():
    ...
    Display search page
    """
    form = SearchEditForm(await request.form)
    movie = []
    tvshow = []
    album = []
    image = []
    ...
    if request.method == 'POST':
        ...
        # search_audio_codec
    return await render_template('users/user_search.html', media=movie, media_tvshow=tvshow,
