...
def db_metathesportsdb_select_guid(self, guid):
    ...
    # select
    """
    self.db_cursor.execute('select mm_metadata_sports_json from mm_metadata_sports'
...
def db_metathesportsdb_insert(self, series_id_json, event_name, show_detail,
    ...
    self.db_cursor.execute('insert into mm_metadata_sports (mm_metadata_sports_guid,'
                           ' mm_metadata_media_sports_id, mm_metadata_sports_name,'
                           ' mm_metadata_sports_json, mm_metadata_sports_image_json)'
                           ' values (%s,%s,%s,%s,%s)',
...
def db_metathesports_update(self, series_id_json, event_name, show_detail,
    ...
    # updated
    """
    self.db_cursor.execute('update mm_metadata_sports set mm_metadata_media_sports_id = %s,'
