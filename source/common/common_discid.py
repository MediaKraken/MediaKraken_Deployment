...
def com_discid_default_device():
    ...
    disc = discid.read()
    common_logging_elasticsearch_httpx.com_es_httpx_post(message_type='info', message_text= {"id": disc.id,
...
def com_discid_caclulate_dir(dir_to_calculate):
    ...
    common_logging_elasticsearch_httpx.com_es_httpx_post(message_type='info', message_text= {"last track length seconds":
                                                         last_track.seconds})
    return disc
