...
if __name__ == '__main__':
    ...
    def finishedSearching(devices):
        ...
        for dk, dv in devices.items():
            ...
            print
            print
            '\tDescribed:', dv.described
            if dv.described:
                print
                '\t\tFriendly Name:', dv.friendlyName
                print
                '\t\tManufacturer:', dv.manufacturer
                print
                '\t\tManufacturer URL:', dv.manufacturerURL
                print
                '\t\tmodelName:', dv.modelName
                print
                '\t\tmodelNumber:', dv.modelNumber
                print
                '\t\tmodelURL:', dv.modelURL
                print
